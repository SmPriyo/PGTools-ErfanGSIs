...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date-byShadesOfDeath"
...
sed -i "s/$bdisplay/$displayid2=BAKED\.WITH\.byShadesOfDeath\.TOOLS/" $systemdir/system/build.prop
